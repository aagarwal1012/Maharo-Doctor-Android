...
import in.ayush.mharodoctor.models.signUp.Output.SignUpOutput;
import in.ayush.mharodoctor.models.signUp.SignUpInterface;
...
public class SignUpActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener, View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        arrayAdapter = new ArrayAdapter<String>(this, android.R.layout.simple_spinner_dropdown_item, Constants.DISTRICT_LIST);
        ...
        if (view.getId() == R.id.button_sign_up) {
            if (username.getText() != null && name.getText() != null && email.getText() != null && aadhaarNumber.getText() != null && mobileNumber.getText() != null && password.getText() != null && retypePassword.getText() != null) {
                if (password.getText().toString().equals(retypePassword.getText().toString())) {
                    ...
                    SignUpInterface signUpInterface = Constants.getRetrofit().create(SignUpInterface.class);
                                ...
                                builder.setTitle("Verification")
                                        ...
                                        .setPositiveButton(android.R.string.ok, new DialogInterface.OnClickListener() {
                                            public void onClick(DialogInterface dialog, int which) {
                                                ...
                                                intent.putExtra(Constants.USER_ID, username.getText().toString());
